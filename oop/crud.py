...
class CRUD:
    ...
    def create(self):
        ...
        val = (name, address)
        cursor.execute("INSERT INTO "+self.__table_name +
                       " (name, address) VALUES (%s, %s)", val)
    ...
    def update(self):
        ...
        cursor.execute("UPDATE "+self.__table_name +
                       " SET name=%s, address=%s WHERE id=%s ", (name, address, id))
    ...
    def delete(self):
        ...
        cursor.execute("DELETE FROM "+self.__table_name +
                       " WHERE id = %s", (id,))
